...
describe("MorphCloud File Operations Tests", () => {
  ...
  test("should test file permissions", async () => {
    ...
    expect(permsResult.exit_code).toBe(0); //
  ...
  test("should perform directory operations", async () => {
    ...
    expect(lsResult.exit_code).toBe(0); //
    ...
    expect(lsDirResult.exit_code).toBe(0); //
    ...
    expect(rmResult.exit_code).toBe(0); //
